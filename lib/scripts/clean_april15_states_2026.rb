...
class April15StatesCleaner
  INPUT_DIR = Rails.root.join('data', '2026_states', 'april15-states')
  ...
  def run
    puts "Cleaning 4 April 15 state CSVs..."
  ...
  # These files use "Yes"/"No"/blank for incumbent
  ...
  # California uses "Withdrawn", others use "Withdrew"
...
cleaner = April15StatesCleaner.new
cleaner.run
